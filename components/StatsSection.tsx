...
export default function StatsSection() {
  ...
  const items = [
    { num: '0001', title: 'La Valeur Réelle', content: 'LE PRIX DU MARCHE BASÉ SUR DES MÉTHODES D\'ESTIMATION PRÉCISES RECONNUES (COMPARATIVE, CAPITALISATION, SOL ET CONSTRUCTION).' },
    ...
    { num: '0004', title: 'Sécurisation Totale', content: 'AUDIT COMPLET. NOUS PRÉPARONS VOTRE DOSSIER POUR QU\'AUCUNE CONDITION SUSPENSIVE NE VIENNE BLOQUER LA VENTE.' },
  ]
