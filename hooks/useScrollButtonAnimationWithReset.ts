 ...
 * Version avec réinitialisation quand une dépendance change (utile pour les boutons dynamiques)
 */
export function useScrollButtonAnimationWithReset(dependency?: any) {
  ...
  useEffect(() => {
    ...
    // Réinitialiser l'animation quand la dépendance change
  ...
  }, [dependency]) // Réexécuter quand la dépendance change
